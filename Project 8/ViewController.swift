...
//  Project 8
//
//  Created by Pablo Rodrigues on 09/11/2021.
//
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        currentAnswer.placeholder = "Guess What ?"
    ...
    @objc func submitTapped (_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            let ac = UIAlertController(title: "Incorrect !", message: "\(answerText) does not match one of the answer!", preferredStyle: .alert)
